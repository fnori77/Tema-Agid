...
?>
    <main>
        ...
        while ( have_posts() ) :
            ...
            <style>
                /* Forza le card ad avere la stessa altezza */
#documenti .card { 
    display: flex;
    flex-direction: column;
    height: 100%; /* Assicura che le card si estendano per tutta l'altezza disponibile */
}

#documenti .card-body {
    flex-grow: 1; /* Forza l'estensione del corpo della card per riempire l'altezza */
}
...
<div data-element="service-addressed">									
                            ...
                            <section class="it-page-section mb-30">
                                ...
                                <div class="richtext-wrapper lora"><p><?php echo $output ?></p></div></div>
                            </section>
                            <?php if ( !empty($fasi_scadenze_intro) || (is_array($fasi_scadenze) && count($fasi_scadenze)) || (is_array($fasi_group_simple_scadenze) && count($fasi_group_simple_scadenze)) ) { ?>
                            <section class="it-page-section mb-30">
                                <div class="cmp-timeline">
                                    ...
                                    <p class="richtext-wrapper lora">
                                     <?php echo $fasi_scadenze_intro; ?>	</p></div>
                            ...
                            <?php } ?>
							<?php 
// Verifica se entrambi i valori sono vuoti
$shouldHideSection = empty($canale_digitale_link) && empty($canale_fisico_text);
?>

<section class="it-page-section mb-30 has-bg-grey" style="
    height: <?php echo $shouldHideSection ? '0px' : 'auto'; ?>; 
    background-color: <?php echo $shouldHideSection ? 'transparent' : 'rgba(113, 113, 113, 0.1)'; ?>; 
    padding: <?php echo $shouldHideSection ? '0' : '1rem'; ?>;
">
    <?php if (!$shouldHideSection) : ?>
        <h2 class="mb-3" id="submit-request" data-element="service-online-access">
            Accedi al servizio
        </h2>
    ...
    <?php endif; ?>
                            ...
                            <section class="it-page-section mb-30">
    <?php 
    if ($documenti && is_array($documenti) && count($documenti) > 0) { 
        ?>
        <h2 class="title-xxlarge mb-3" id="more-info">Documenti correlati</h2>
        <article id="documenti" class="it-page-section anchor-offset mt-5">
            <div class="row d-flex flex-wrap"> <!-- Utilizzo di Flexbox -->
                <?php 
                foreach ($documenti as $documenti_id) {
                    $documento = get_post($documenti_id);
                    $with_border = true;
                    ?>
                    <div class="col-12 col-md-6 d-flex align-items-stretch mb-4"> <!-- Flexbox per uniformare altezza -->

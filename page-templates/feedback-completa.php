...
/* Template Name: Feeback completo
 *
...
<section class="container mb-4">
    ...
    <!-- Section description -->
    <p class="text-center w-responsive mx-auto mb-5">Potete usare questo spazio per inviare la vostra opinione sulle funzionalit&aacute; e sull'usabilit&aacute;  del sito.</p>

    <div class="row">
        <!-- Grid column -->
        <div class="col-md-8 mx-auto">
            <form action="https://comune.nerola.rm.it/wp-content/themes/design-comuni-wordpress-theme-figlio/page-templates/invio-feedback.php"
                  method="post" enctype="multipart/form-data" onsubmit="return valida();" class="needs-validation" novalidate>

                <input type="hidden" name="destinatario" value="segreterianerola@pec.provincia.roma.it">

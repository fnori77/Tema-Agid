          ...
          <div class="card w-100">
            <div class="card-body">
              ...
              <ul class="contact-list p-0">
                ...
                <li>
                  <a class="list-item" href="<?php echo get_home_url(); ?>/richiesta-assistenza" data-element="contacts"
              ...
              <ul class="contact-list p-0">
                <li>
                  <a class="list-item" href="<?php echo get_home_url(); ?>/segnalazione-disservizio"
                    ><svg class="icon icon-primary icon-sm" aria-hidden="true">
                      <use

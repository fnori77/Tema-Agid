...
<footer class="it-footer" id="footer">
        ...
        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <p class="footer-info">
                                ...
                                <br /><?php if(dci_get_option("contatti_CF_PIVA",'footer')) echo 'Cod. Fisc. e P. IVA:<br>' . dci_get_option("contatti_CF_PIVA",'footer'); ?>
                                <br />
                                <?php
            ...
            <div class="row">
                ...
                <!-- Per favore, non rimuoverlo! -->
                                Powered by <a target="_blank" href="https://www.we-com.it/" title="Soluzioni informatiche"><strong>We-COM srl</strong></a>
				<!-- Grazie :) -->               
                <br>
            </section>
  ...
  <div class="cookiebar-buttons">
    <a href="<?php echo get_home_url(); ?>/cookie" class="cookiebar-btn">Preferenze<span class="visually-hidden">cookies</span></a>

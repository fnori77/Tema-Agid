...
if(!function_exists("dci_get_calendar")) {
    function dci_get_calendar($days = 8){
...
$start_date = strtotime('today'); // Data di inizio (oggi)
$end_date = strtotime('+15 days'); // Data di fine (15 giorni da oggi)
...
$args = array(
    ...
    'fields' => 'ids',
    'meta_query' => array(
        'relation' => 'AND', // Assicurati che entrambe le condizioni siano soddisfatte
        array(
            'key'     => '_dci_evento_data_orario_inizio',
            'value'   => $start_date, // Verifica se l'orario di inizio è uguale alla data di inizio
            'compare' => '>', // Confronto di uguaglianza
            'type'    => 'NUMERIC' // Assicurati che il confronto sia fatto come numero
        ),
        array(
            'key'     => '_dci_evento_data_orario_fine',
            'value'   => $end_date, // Verifica se l'orario di fine è uguale alla data di fine
            'compare' => '<', // Confronto di uguaglianza
            'type'    => 'NUMERIC' // Assicurati che il confronto sia fatto come numero
        )
    ),

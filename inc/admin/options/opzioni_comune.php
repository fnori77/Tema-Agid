...
function dci_register_comune_options(){
    ...
    $header_options->add_field( array(
        'id'    => $prefix . 'immagine_comune',
        'name' => __('Header', 'design_comuni_italia' ),
        'desc' => __( 'Caricare immagine comune formato jpg o jpeg' , 'design_comuni_italia' ),
        'type' => 'file',
        'query_args'   => array(
        'type' => array(
            'image/jpeg',
    ...
    $header_options->add_field( array(
        ...
        'desc' => __( 'Scrivi il titolo' , 'design_comuni_italia' ),
        'type' => 'text',
    ) );
    ...
    $header_options->add_field( array(
        ...
        'desc' => __( 'Scrivi la descrizione' , 'design_comuni_italia' ),
        'type' => 'text',
    ) );

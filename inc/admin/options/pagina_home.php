...
function dci_register_pagina_home_options(){
    ...
    //scheda 4
    $schede_group_id = $home_options->add_field( array(
        'id'           => $prefix . 'schede_evidenziate_4',
        'type'        => 'group',
        'repeatable'  => false,
        'options'     => array(
            'group_title'       => 'Scheda 4:',
       )
    ) );
    $home_options->add_group_field( $schede_group_id, array(
            'name' => __('<h5>Selezione contenuto</h5>', 'design_comuni_italia'),
            'desc' => __('Seleziona il contenuto da mostrare nella Scheda. ', 'design_comuni_italia'),
            'id' => $prefix . 'scheda_4_contenuto',
            'type'    => 'custom_attached_posts',
            'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
            'options' => array(
                'show_thumbnails' => false, // Show thumbnails on the left
    ...
    //scheda 5
    $schede_group_id = $home_options->add_field( array(
        'id'           => $prefix . 'schede_evidenziate_5',
        'type'        => 'group',
        'repeatable'  => false,
        'options'     => array(
            'group_title'       => 'Scheda 5:',
       )
    ) );
    $home_options->add_group_field( $schede_group_id, array(
            'name' => __('<h5>Selezione contenuto</h5>', 'design_comuni_italia'),
            'desc' => __('Seleziona il contenuto da mostrare nella Scheda. ', 'design_comuni_italia'),
            'id' => $prefix . 'scheda_5_contenuto',
            'type'    => 'custom_attached_posts',
            'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
            'options' => array(
                'show_thumbnails' => false, // Show thumbnails on the left
    ...
    //scheda 6
    $schede_group_id = $home_options->add_field( array(
        'id'           => $prefix . 'schede_evidenziate_6',
        'type'        => 'group',
        'repeatable'  => false,
        'options'     => array(
            'group_title'       => 'Scheda 6:',
       )
    ) );
    $home_options->add_group_field( $schede_group_id, array(
            'name' => __('<h5>Selezione contenuto</h5>', 'design_comuni_italia'),
            'desc' => __('Seleziona il contenuto da mostrare nella Scheda. ', 'design_comuni_italia'),
            'id' => $prefix . 'scheda_6_contenuto',
            'type'    => 'custom_attached_posts',
            'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
            'options' => array(
                'show_thumbnails' => false, // Show thumbnails on the left
    ...
    $home_options->add_field( array(
        ...
        'attributes' => array(
            'data-maximum-selection-length' => '9',
        ),
    ) );
    ...
    $argomenti_group_id = $home_options->add_field( array(
        'id'           => $prefix . 'argomenti_evidenziati_4',
        'type'        => 'group',
        'repeatable'  => false,
        'options'     => array(
            'group_title'   => __( 'Argomento 4: ', 'design_comuni_italia' ),
            'closed' => true
        ),
    ) );
    
    $home_options->add_group_field( $argomenti_group_id, array(
        'id' => $prefix . 'argomento_4_argomento',
        'name'        => __( 'Argomento', 'design_comuni_italia' ),
        'desc' => __( 'Seleziona l\'Argomento' , 'design_comuni_italia' ),
        'type' => 'taxonomy_select',
        'taxonomy'=>'argomenti'
    ...
    $home_options->add_group_field( $argomenti_group_id, array(
        'id' => $prefix . 'argomento_4_siti_tematici',
        'name'        => __( 'Sito Tematico ', 'design_comuni_italia' ),
        'desc' => __( 'Selezionare il sito tematico da inserire nella Card' , 'design_comuni_italia' ),
        'type'    => 'pw_select',
        'options' => dci_get_posts_options('sito_tematico'),
    ...
    $home_options->add_group_field( $argomenti_group_id, array(
            'name' => __('<h5>Selezione contenuti</h5>', 'design_comuni_italia'),
            'desc' => __('Seleziona i contenuti da mostrare nella Card dell\'Argomento. ', 'design_comuni_italia'),
            'id' => $prefix . 'argomento_4_contenuti',
            'type'    => 'custom_attached_posts',
            'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
            'options' => array(
                'show_thumbnails' => false, // Show thumbnails on the left
...
// Argomento 5
$argomenti_group_id = $home_options->add_field( array(
    'id'           => $prefix . 'argomenti_evidenziati_5',
    'type'        => 'group',
    'repeatable'  => false,
    'options'     => array(
        'group_title'   => __( 'Argomento 5: ', 'design_comuni_italia' ),
        'closed' => true
    ),
) );

$home_options->add_group_field( $argomenti_group_id, array(
    'id' => $prefix . 'argomento_5_argomento',
    'name'        => __( 'Argomento', 'design_comuni_italia' ),
    'desc' => __( 'Seleziona l\'Argomento' , 'design_comuni_italia' ),
    'type' => 'taxonomy_select',
    'taxonomy'=>'argomenti'
...
$home_options->add_group_field( $argomenti_group_id, array(
    'id' => $prefix . 'argomento_5_siti_tematici',
    'name'        => __( 'Sito Tematico ', 'design_comuni_italia' ),
    'desc' => __( 'Selezionare il sito tematico da inserire nella Card' , 'design_comuni_italia' ),
    'type'    => 'pw_select',
    'options' => dci_get_posts_options('sito_tematico'),
...
$home_options->add_group_field( $argomenti_group_id, array(
        'name' => __('<h5>Selezione contenuti</h5>', 'design_comuni_italia'),
        'desc' => __('Seleziona i contenuti da mostrare nella Card dell\'Argomento. ', 'design_comuni_italia'),
        'id' => $prefix . 'argomento_5_contenuti',
        'type'    => 'custom_attached_posts',
        'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
        'options' => array(
            'show_thumbnails' => false, // Show thumbnails on the left
...
// Argomento 6
$argomenti_group_id = $home_options->add_field( array(
    'id'           => $prefix . 'argomenti_evidenziati_6',
    'type'        => 'group',
    'repeatable'  => false,
    'options'     => array(
        'group_title'   => __( 'Argomento 6: ', 'design_comuni_italia' ),
        'closed' => true
    ),
) );

$home_options->add_group_field( $argomenti_group_id, array(
    'id' => $prefix . 'argomento_6_argomento',
    'name'        => __( 'Argomento', 'design_comuni_italia' ),
    'desc' => __( 'Seleziona l\'Argomento' , 'design_comuni_italia' ),
    'type' => 'taxonomy_select',
    'taxonomy'=>'argomenti'
...
$home_options->add_group_field( $argomenti_group_id, array(
    'id' => $prefix . 'argomento_6_siti_tematici',
    'name'        => __( 'Sito Tematico ', 'design_comuni_italia' ),
    'desc' => __( 'Selezionare il sito tematico da inserire nella Card' , 'design_comuni_italia' ),
    'type'    => 'pw_select',
    'options' => dci_get_posts_options('sito_tematico'),
...
$home_options->add_group_field( $argomenti_group_id, array(
        'name' => __('<h5>Selezione contenuti</h5>', 'design_comuni_italia'),
        'desc' => __('Seleziona i contenuti da mostrare nella Card dell\'Argomento. ', 'design_comuni_italia'),
        'id' => $prefix . 'argomento_6_contenuti',
        'type'    => 'custom_attached_posts',
        'column'  => true, // Output in the admin post-listing as a custom column. https://github.com/CMB2/CMB2/wiki/Field-Parameters#column
        'options' => array(
            'show_thumbnails' => false, // Show thumbnails on the left

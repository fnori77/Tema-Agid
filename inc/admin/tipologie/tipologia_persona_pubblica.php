...
function dci_add_persona_pubblica_metaboxes() {
    ...
    'desc'           => __( 'Seleziona il tipo di incarico', 'design_comuni_italia' ),
    'type'           => 'radio',
    'default'        => 'amministrativo', // Imposta il valore predefinito a "amministrativo"
    'options'        => array(
        'Amministrativo'   => __( 'Incarico Amministrativo', 'design_comuni_italia' ),
        'Politico'         => __( 'Incarico Politico', 'design_comuni_italia' ),
    ),
) );

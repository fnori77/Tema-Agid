<style>
	.circle-container {
    width: 300px; /* Larghezza del contenitore circolare */
    height: 300px; /* Altezza del contenitore circolare */
    overflow: hidden;
    border-radius: 50%; /* Rendi il contenitore circolare */
    position: relative; /* Per centrare l'immagine all'interno del contenitore */
}

.circle-container img {
    width: auto; /* Larghezza automatica per mantenere l'aspetto proporzionale */
    height: 100%; /* Fai sì che l'immagine riempia tutto l'altezza del contenitore */
    position: absolute; /* Per centrare l'immagine all'interno del contenitore */
    top: 50%; /* Sposta l'immagine verso il centro verticalmente */
    left: 50%; /* Sposta l'immagine verso il centro orizzontalmente */
    transform: translate(-50%, -50%); /* Centra l'immagine all'interno del contenitore */
}
...
<main>
  ...
  while (have_posts()) :
	...
	$patrimoniale = dci_get_meta("situazione_patrimoniale");
                  ...
                  <div class="link-list-wrapper">
                    <div class="accordion">
                      <div class="accordion-item">
                        ...
                        <?php if(isset($curriculum_vitae) && !empty($curriculum_vitae)): ?>
    <li class="nav-item">
...
<?php endif; ?>
  ...
  <div class="row">
   ...
   <h2 class="title-xxlarge mb-3" id="ruolo">Incarico</h2>
	
              <div class="richtext-wrapper lora">
                <?php echo $descrizione_breve ?>
              </div>
   <h3 class="title-xxlarge mb-3" id="ruolo">Tipo di incarico</h3>
              <div class="richtext-wrapper lora">
           ...
           <?php
// Verifica se $deleghe è valorizzato e non è vuoto
if (isset($deleghe) && !empty($deleghe)) {
    // Se $deleghe ha un valore, mostra il campo
    ?>
    <p><b>Deleghe</b></p>
    <div class="richtext-wrapper lora">
        <?php echo $deleghe; ?>
...
<?php endif; ?>
           <?php
// Verifica se $patrimoniale è valorizzato e non è vuoto
if (isset($patrimoniale) && !empty($patrimoniale)) {
    // Se $patrimoniale ha un valore, mostra il campo
    ?>
    <p><b>Situazione patrimoniale</b></p>
    <div class="richtext-wrapper lora">
        <?php echo $patrimoniale; ?>
    </div>
    <br>
    <?php
}
